...
func (x *Dir) GetFilenames() []string {
	if x != nil {
		return x.Filenames
	}
	return nil
...
const file_proto_fileservice_proto_rawDesc = "" +
	"\n" +
	"\x17proto/fileservice.proto\x12\vfileservice\"\x1a\n" +
	"\x04path\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\"#\n" +
	"\x03dir\x12\x1c\n" +
	"\tfilenames\x18\x01 \x03(\tR\tfilenames2?\n" +
	"\ffile_service\x12/\n" +
	"\blist_dir\x12\x11.fileservice.path\x1a\x10.fileservice.dirB\x14Z\x12grpc-seminar/protob\x06proto3"
...
var file_proto_fileservice_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_fileservice_proto_goTypes = []any{
	(*Path)(nil), // 0: fileservice.path
	(*Dir)(nil),  // 1: fileservice.dir
}
var file_proto_fileservice_proto_depIdxs = []int32{
	0, // 0: fileservice.file_service.list_dir:input_type -> fileservice.path
	1, // 1: fileservice.file_service.list_dir:output_type -> fileservice.dir
